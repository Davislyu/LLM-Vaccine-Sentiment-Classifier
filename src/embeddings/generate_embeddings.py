...
def generate_embeddings(input_file, output_file):
    ...
    ctbert_embeddings = get_ctbert_embeddings(texts, model_ct, tokenizer_ct, batch_size=16)
    sbert_embeddings = get_sbert_embeddings(texts, model_sbert, tokenizer_sbert, batch_size=16)

    combined_embeddings = ctbert_embeddings + sbert_embeddings  # Maintain dimension consistency
